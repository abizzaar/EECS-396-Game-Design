...
namespace Assets.Scripts
{
    public class Wave : MonoBehaviour
    {
        ...
        void Spawn()
        {
            ...
            Enemy newEnemy = Instantiate(MobTypes[Enemy_type], gameObject.transform.position, new Quaternion(), gameObject.transform);
            newEnemy.Health = newEnemy.Health * Wave_num;
