...
namespace Assets.Scripts
{
    public class Bullet : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            gameObject.GetComponent<Rigidbody>().velocity = new Vector3(_targetPosition.x - _myPosition.x, _targetPosition.y - _myPosition.y, _targetPosition.z - _myPosition.z); //Homes in
